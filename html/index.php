  ...
  <section class="about-body">
    ...
    <div class="about__text">
      <p>
        ...
        <br>사람을 위해 질서와 목적을 따라 계획하고 설계하셨습니다.
      </p>
      <p>
        삼마디자인은 세속적 흐름 속에 무너져 가는 디자인 영역을
        <br>하나님의 창조 질서로 회복하기 위해 세워졌습니다.
      </p>
      <p>
        디자인은 단순한 표현이 아니라 세계관을 담는 설계입니다.
      </p>
      <p>
        우리는 하나님의 말씀으로 훈련된 디자인 일꾼을 세우고 지역 교회와 공동체를 섬기며
        <br>이 땅 가운데 하나님의 계획이 온전히 세워지도록 돕습니다.
      </p>
    </div>
  </section>
